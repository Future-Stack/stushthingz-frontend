        ...
        <section className="relative overflow-hidden text-white bg-[linear-gradient(135deg,#D91A7C_0%,#D51A7A_10%,#D11977_20%,#CD1975_30%,#C81873_40%,#C41870_50%,#C0176E_60%,#BC176C_70%,#B8166A_80%,#B41667_90%,#B01565_100%)]">
            <CommonWrapper>
                ...
                <img
                    src={watermark}
                    alt="right shape"
                    className="hidden lg:block absolute lg:right-40 top-1/2 -translate-y-1/2 opacity-10 w-32 md:w-44 pointer-events-none -rotate-180"
                />
                ...
                <div className="px-6 py-16 text-center">
                    ...
                    <p className="text-sm md:text-lg text-pink-100 mb-6">
                        Join foreign investors who trust Vanessa to navigate Jamaica’s real estate market
                    </p>

                    <button className="bg-white text-pink-700 font-semibold px-6 py-3 rounded-lg shadow hover:bg-pink-100 transition">
                        Get Started Now →
                    </button>
                </div>
            </CommonWrapper>
