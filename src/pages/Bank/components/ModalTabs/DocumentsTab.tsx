    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {documents.uploadedDocuments.map((doc) => (
          <div key={doc.id} className="flex justify-between items-center p-4 border border-gray-100 rounded-xl">
            ...
            <div className="flex items-center gap-3">
              {doc.status === "accepted" ? (
                <div className="flex items-center gap-1 bg-[#00C950] px-2 py-1 rounded font-bold text-[11px] text-white">
                  <CheckCircle2 size={12} />
                  Uploaded
                </div>
              ) : (
                <div className="flex items-center gap-1 bg-white px-2 py-1 border border-[#EF4444] rounded font-bold text-[#EF4444] text-[11px]">
                  <AlertCircle size={12} />
              ...
              <button
                ...
                className="flex items-center gap-1.5 hover:bg-gray-50 px-3 py-1.5 border border-gray-200 rounded-lg font-bold text-gray-700 text-xs transition-colors cursor-pointer"
              >
                <Eye size={14} />
                View
              </button>
